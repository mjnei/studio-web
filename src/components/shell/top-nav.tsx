        ...
        <div className="ml-auto flex items-center gap-1.5 md:gap-2">
          ...
          <div className="hidden lg:block relative">
            ...
            <input
              ...
              className="w-64 rounded-lg border border-border-default bg-surface-raised pl-9 pr-3 py-1.5 text-sm text-text-primary placeholder-text-muted focus:border-accent-primary focus:ring-2 focus:ring-accent-primary/20 focus:outline-none transition-all hover:border-border-strong"
            />
          </div>
