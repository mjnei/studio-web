    ...
    <div className="mb-4 space-y-3">
      ...
      >
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {/* Action Filter */}
          <div>
            <label className="mb-1 block text-caption font-medium text-text-muted">Action</label>
            <input
              type="text"
              placeholder="e.g., create, update, delete"
              value={localFilters.action || ""}
              onChange={(e) => handleInputChange("action", e.target.value)}
              className="w-full rounded-lg border-2 border-border bg-background px-3 py-2 text-body text-text-primary placeholder:text-text-muted focus:border-primary focus:outline-none"
            />
          </div>

          {/* User ID Filter */}
          <div>
            <label className="mb-1 block text-caption font-medium text-text-muted">User ID</label>
            <input
              type="number"
          ...
          {/* Date From Filter */}
          <div>
            <label className="mb-1 block text-caption font-medium text-text-muted">Date From</label>
            <input
              type="date"
              value={localFilters.date_from || ""}
              onChange={(e) => handleInputChange("date_from", e.target.value)}
              className="w-full rounded-lg border-2 border-border bg-background px-3 py-2 text-body text-text-primary focus:border-primary focus:outline-none"
            />
          </div>

          {/* Date To Filter */}
          <div>
            <label className="mb-1 block text-caption font-medium text-text-muted">Date To</label>
            <input
              type="date"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg border-2 border-border bg-background pl-10 pr-3 py-2 text-body text-text-primary placeholder:text-text-muted focus:border-primary focus:outline-none"
              />
            </div>
          </div>
        </div>
